...
type types = [
| [@bs.as "application/1d-interleaved-parityfec"] `application_1dinterleavedparityfec
| [@bs.as "application/3gpdash-qoe-report+xml"] `application_3gpdashqoereportxml
...
| [@bs.as "application/alto-costmapfilter+json"] `application_altocostmapfilterjson
| [@bs.as "application/alto-directory+json"] `application_altodirectoryjson
| [@bs.as "application/alto-endpointprop+json"] `application_altoendpointpropjson
| [@bs.as "application/alto-endpointpropparams+json"] `application_altoendpointpropparamsjson
| [@bs.as "application/alto-endpointcost+json"] `application_altoendpointcostjson
| [@bs.as "application/alto-endpointcostparams+json"] `application_altoendpointcostparamsjson
| [@bs.as "application/alto-error+json"] `application_altoerrorjson
| [@bs.as "application/alto-networkmapfilter+json"] `application_altonetworkmapfilterjson
...
| [@bs.as "application/EmergencyCallData.Comment+xml"] `application_EmergencyCallDataCommentxml
| [@bs.as "application/EmergencyCallData.Control+xml"] `application_EmergencyCallDataControlxml
| [@bs.as "application/EmergencyCallData.DeviceInfo+xml"] `application_EmergencyCallDataDeviceInfoxml
| [@bs.as "application/EmergencyCallData.eCall.MSD"] `application_EmergencyCallDataeCallMSD
| [@bs.as "application/EmergencyCallData.ProviderInfo+xml"] `application_EmergencyCallDataProviderInfoxml
| [@bs.as "application/EmergencyCallData.ServiceInfo+xml"] `application_EmergencyCallDataServiceInfoxml
| [@bs.as "application/EmergencyCallData.SubscriberInfo+xml"] `application_EmergencyCallDataSubscriberInfoxml
| [@bs.as "application/EmergencyCallData.VEDS+xml"] `application_EmergencyCallDataVEDSxml
...
| [@bs.as "application/framework-attributes+xml"] `application_frameworkattributesxml
...
| [@bs.as "application/mbms-associated-procedure-description+xml"] `application_mbmsassociatedproceduredescriptionxml
...
| [@bs.as "application/mbms-msk-response+xml"] `application_mbmsmskresponsexml
| [@bs.as "application/mbms-msk+xml"] `application_mbmsmskxml
| [@bs.as "application/mbms-protection-description+xml"] `application_mbmsprotectiondescriptionxml
| [@bs.as "application/mbms-reception-report+xml"] `application_mbmsreceptionreportxml
| [@bs.as "application/mbms-register-response+xml"] `application_mbmsregisterresponsexml
...
| [@bs.as "application/mbms-user-service-description+xml"] `application_mbmsuserservicedescriptionxml
| [@bs.as "application/mbox"] `application_mbox
| [@bs.as "application/media_control+xml"] `application_media_controlxml
| [@bs.as "application/media-policy-dataset+xml"] `application_mediapolicydatasetxml
| [@bs.as "application/mediaservercontrol+xml"] `application_mediaservercontrolxml
...
| [@bs.as "application/prs.alvestrand.titrax-sheet"] `application_prsalvestrandtitraxsheet
...
| [@bs.as "application/relax-ng-compact-syntax"] `application_relaxngcompactsyntax
| [@bs.as "application/remote-printing"] `application_remoteprinting
| [@bs.as "application/reputon+json"] `application_reputonjson
| [@bs.as "application/resource-lists-diff+xml"] `application_resourcelistsdiffxml
...
| [@bs.as "application/set-payment-initiation"] `application_setpaymentinitiation
| [@bs.as "application/set-registration"] `application_setregistration
| [@bs.as "application/set-registration-initiation"] `application_setregistrationinitiation
...
| [@bs.as "application/simple-message-summary"] `application_simplemessagesummary
| [@bs.as "application/simpleSymbolContainer"] `application_simpleSymbolContainer
...
| [@bs.as "application/tamp-apex-update-confirm"] `application_tampapexupdateconfirm
| [@bs.as "application/tamp-community-update"] `application_tampcommunityupdate
| [@bs.as "application/tamp-community-update-confirm"] `application_tampcommunityupdateconfirm
| [@bs.as "application/tamp-error"] `application_tamperror
| [@bs.as "application/tamp-sequence-adjust"] `application_tampsequenceadjust
| [@bs.as "application/tamp-sequence-adjust-confirm"] `application_tampsequenceadjustconfirm
...
| [@bs.as "application/vnd.1000minds.decision-model+xml"] `application_vnd1000mindsdecisionmodelxml
| [@bs.as "application/vnd.3gpp.access-transfer-events+xml"] `application_vnd3gppaccesstransfereventsxml
...
| [@bs.as "application/vnd.3gpp.mcptt-affiliation-command+xml"] `application_vnd3gppmcpttaffiliationcommandxml
| [@bs.as "application/vnd.3gpp.mcptt-floor-request+xml"] `application_vnd3gppmcpttfloorrequestxml
| [@bs.as "application/vnd.3gpp.mcptt-info+xml"] `application_vnd3gppmcpttinfoxml
| [@bs.as "application/vnd.3gpp.mcptt-location-info+xml"] `application_vnd3gppmcpttlocationinfoxml
| [@bs.as "application/vnd.3gpp.mcptt-mbms-usage-info+xml"] `application_vnd3gppmcpttmbmsusageinfoxml
| [@bs.as "application/vnd.3gpp.mcptt-signed+xml"] `application_vnd3gppmcpttsignedxml
...
| [@bs.as "application/vnd.3gpp-prose-pc3ch+xml"] `application_vnd3gppprosepc3chxml
...
| [@bs.as "application/vnd.3gpp.srvcc-ext+xml"] `application_vnd3gppsrvccextxml
| [@bs.as "application/vnd.3gpp.SRVCC-info+xml"] `application_vnd3gppSRVCCinfoxml
| [@bs.as "application/vnd.3gpp.state-and-event-info+xml"] `application_vnd3gppstateandeventinfoxml
| [@bs.as "application/vnd.3gpp.ussd+xml"] `application_vnd3gppussdxml
| [@bs.as "application/vnd.3gpp-v2x-local-service-information"] `application_vnd3gppv2xlocalserviceinformation
| [@bs.as "application/vnd.3gpp2.bcmcsinfo+xml"] `application_vnd3gpp2bcmcsinfoxml
| [@bs.as "application/vnd.3gpp2.sms"] `application_vnd3gpp2sms
| [@bs.as "application/vnd.3gpp2.tcap"] `application_vnd3gpp2tcap
| [@bs.as "application/vnd.3lightssoftware.imagescal"] `application_vnd3lightssoftwareimagescal
| [@bs.as "application/vnd.3M.Post-it-Notes"] `application_vnd3MPostitNotes
| [@bs.as "application/vnd.accpac.simply.aso"] `application_vndaccpacsimplyaso
| [@bs.as "application/vnd.accpac.simply.imp"] `application_vndaccpacsimplyimp
| [@bs.as "application/vnd-acucobol"] `application_vndacucobol
| [@bs.as "application/vnd.acucorp"] `application_vndacucorp
| [@bs.as "application/vnd.adobe.flash-movie"] `application_vndadobeflashmovie
| [@bs.as "application/vnd.adobe.formscentral.fcdt"] `application_vndadobeformscentralfcdt
| [@bs.as "application/vnd.adobe.fxp"] `application_vndadobefxp
| [@bs.as "application/vnd.adobe.partial-upload"] `application_vndadobepartialupload
...
| [@bs.as "application/vnd.airzip.filesecure.azf"] `application_vndairzipfilesecureazf
| [@bs.as "application/vnd.airzip.filesecure.azs"] `application_vndairzipfilesecureazs
| [@bs.as "application/vnd.amadeus+json"] `application_vndamadeusjson
| [@bs.as "application/vnd.amazon.mobi8-ebook"] `application_vndamazonmobi8ebook
| [@bs.as "application/vnd.americandynamics.acc"] `application_vndamericandynamicsacc
| [@bs.as "application/vnd.amiga.ami"] `application_vndamigaami
| [@bs.as "application/vnd.amundsen.maze+xml"] `application_vndamundsenmazexml
| [@bs.as "application/vnd.anki"] `application_vndanki
| [@bs.as "application/vnd.anser-web-certificate-issue-initiation"] `application_vndanserwebcertificateissueinitiation
| [@bs.as "application/vnd.antix.game-component"] `application_vndantixgamecomponent
| [@bs.as "application/vnd.apache.thrift.binary"] `application_vndapachethriftbinary
| [@bs.as "application/vnd.apache.thrift.compact"] `application_vndapachethriftcompact
| [@bs.as "application/vnd.apache.thrift.json"] `application_vndapachethriftjson
| [@bs.as "application/vnd.api+json"] `application_vndapijson
| [@bs.as "application/vnd.apothekende.reservation+json"] `application_vndapothekendereservationjson
| [@bs.as "application/vnd.apple.mpegurl"] `application_vndapplempegurl
| [@bs.as "application/vnd.apple.installer+xml"] `application_vndappleinstallerxml
| [@bs.as "application/vnd.arastra.swi"] `application_vndarastraswi
| [@bs.as "application/vnd.aristanetworks.swi"] `application_vndaristanetworksswi
| [@bs.as "application/vnd.artisan+json"] `application_vndartisanjson
| [@bs.as "application/vnd.artsquare"] `application_vndartsquare
| [@bs.as "application/vnd.astraea-software.iota"] `application_vndastraeasoftwareiota
...
| [@bs.as "application/vnd.balsamiq.bmml+xml"] `application_vndbalsamiqbmmlxml
...
| [@bs.as "application/vnd.bekitzur-stech+json"] `application_vndbekitzurstechjson
...
| [@bs.as "application/vnd.blink-idb-value-wrapper"] `application_vndblinkidbvaluewrapper
| [@bs.as "application/vnd.blueice.multipass"] `application_vndblueicemultipass
...
| [@bs.as "application/vnd.capasystems-pg+json"] `application_vndcapasystemspgjson
| [@bs.as "application/vnd.cendio.thinlinc.clientconf"] `application_vndcendiothinlincclientconf
| [@bs.as "application/vnd.century-systems.tcp_stream"] `application_vndcenturysystemstcp_stream
| [@bs.as "application/vnd.chemdraw+xml"] `application_vndchemdrawxml
| [@bs.as "application/vnd.chess-pgn"] `application_vndchesspgn
| [@bs.as "application/vnd.chipnuts.karaoke-mmd"] `application_vndchipnutskaraokemmd
...
| [@bs.as "application/vnd.citationstyles.style+xml"] `application_vndcitationstylesstylexml
...
| [@bs.as "application/vnd.cluetrust.cartomobile-config"] `application_vndcluetrustcartomobileconfig
| [@bs.as "application/vnd.cluetrust.cartomobile-config-pkg"] `application_vndcluetrustcartomobileconfigpkg
| [@bs.as "application/vnd.coffeescript"] `application_vndcoffeescript
| [@bs.as "application/vnd.collabio.xodocuments.document"] `application_vndcollabioxodocumentsdocument
| [@bs.as "application/vnd.collabio.xodocuments.document-template"] `application_vndcollabioxodocumentsdocumenttemplate
| [@bs.as "application/vnd.collabio.xodocuments.presentation"] `application_vndcollabioxodocumentspresentation
| [@bs.as "application/vnd.collabio.xodocuments.presentation-template"] `application_vndcollabioxodocumentspresentationtemplate
| [@bs.as "application/vnd.collabio.xodocuments.spreadsheet"] `application_vndcollabioxodocumentsspreadsheet
| [@bs.as "application/vnd.collabio.xodocuments.spreadsheet-template"] `application_vndcollabioxodocumentsspreadsheettemplate
| [@bs.as "application/vnd.collection.doc+json"] `application_vndcollectiondocjson
| [@bs.as "application/vnd.collection+json"] `application_vndcollectionjson
| [@bs.as "application/vnd.collection.next+json"] `application_vndcollectionnextjson
...
| [@bs.as "application/vnd.commerce-battelle"] `application_vndcommercebattelle
| [@bs.as "application/vnd.commonspace"] `application_vndcommonspace
| [@bs.as "application/vnd.coreos.ignition+json"] `application_vndcoreosignitionjson
...
| [@bs.as "application/vnd.crick.clicker.keyboard"] `application_vndcrickclickerkeyboard
| [@bs.as "application/vnd.crick.clicker.palette"] `application_vndcrickclickerpalette
| [@bs.as "application/vnd.crick.clicker.template"] `application_vndcrickclickertemplate
| [@bs.as "application/vnd.crick.clicker.wordbank"] `application_vndcrickclickerwordbank
| [@bs.as "application/vnd.criticaltools.wbs+xml"] `application_vndcriticaltoolswbsxml
...
| [@bs.as "application/vnd.cyan.dean.root+xml"] `application_vndcyandeanrootxml
| [@bs.as "application/vnd.cybank"] `application_vndcybank
| [@bs.as "application/vnd.d2l.coursepackage1p0+zip"] `application_vndd2lcoursepackage1p0zip
...
| [@bs.as "application/vnd.dataresource+json"] `application_vnddataresourcejson
| [@bs.as "application/vnd.debian.binary-package"] `application_vnddebianbinarypackage
...
| [@bs.as "application/vnd.denovo.fcselayout-link"] `application_vnddenovofcselayoutlink
| [@bs.as "application/vnd.desmume-movie"] `application_vnddesmumemovie
| [@bs.as "application/vnd.dir-bi.plate-dl-nosuffix"] `application_vnddirbiplatedlnosuffix
| [@bs.as "application/vnd.dm.delegation+xml"] `application_vnddmdelegationxml
...
| [@bs.as "application/vnd.doremir.scorecloud-binary-document"] `application_vnddoremirscorecloudbinarydocument
...
| [@bs.as "application/vnd.dvb.ipdcdftnotifaccess"] `application_vnddvbipdcdftnotifaccess
| [@bs.as "application/vnd.dvb.ipdcesgaccess"] `application_vnddvbipdcesgaccess
| [@bs.as "application/vnd.dvb.ipdcesgaccess2"] `application_vnddvbipdcesgaccess2
...
| [@bs.as "application/vnd.dvb.iptv.alfec-base"] `application_vnddvbiptvalfecbase
| [@bs.as "application/vnd.dvb.iptv.alfec-enhancement"] `application_vnddvbiptvalfecenhancement
| [@bs.as "application/vnd.dvb.notif-aggregate-root+xml"] `application_vnddvbnotifaggregaterootxml
| [@bs.as "application/vnd.dvb.notif-container+xml"] `application_vnddvbnotifcontainerxml
| [@bs.as "application/vnd.dvb.notif-generic+xml"] `application_vnddvbnotifgenericxml
| [@bs.as "application/vnd.dvb.notif-ia-msglist+xml"] `application_vnddvbnotifiamsglistxml
| [@bs.as "application/vnd.dvb.notif-ia-registration-request+xml"] `application_vnddvbnotifiaregistrationrequestxml
| [@bs.as "application/vnd.dvb.notif-ia-registration-response+xml"] `application_vnddvbnotifiaregistrationresponsexml
| [@bs.as "application/vnd.dvb.notif-init+xml"] `application_vnddvbnotifinitxml
...
| [@bs.as "application/vnd.easykaraoke.cdgdownload"] `application_vndeasykaraokecdgdownload
...
| [@bs.as "application/vnd.ecowin.filerequest"] `application_vndecowinfilerequest
| [@bs.as "application/vnd.ecowin.fileupdate"] `application_vndecowinfileupdate
| [@bs.as "application/vnd.ecowin.series"] `application_vndecowinseries
| [@bs.as "application/vnd.ecowin.seriesrequest"] `application_vndecowinseriesrequest
| [@bs.as "application/vnd.ecowin.seriesupdate"] `application_vndecowinseriesupdate
| [@bs.as "application/vnd.efi-img"] `application_vndefiimg
| [@bs.as "application/vnd.efi-iso"] `application_vndefiiso
| [@bs.as "application/vnd.emclient.accessrequest+xml"] `application_vndemclientaccessrequestxml
...
| [@bs.as "application/vnd.ericsson.quickcall"] `application_vndericssonquickcall
| [@bs.as "application/vnd.espass-espass+zip"] `application_vndespassespasszip
...
| [@bs.as "application/vnd.etsi.iptvcommand+xml"] `application_vndetsiiptvcommandxml
| [@bs.as "application/vnd.etsi.iptvdiscovery+xml"] `application_vndetsiiptvdiscoveryxml
| [@bs.as "application/vnd.etsi.iptvprofile+xml"] `application_vndetsiiptvprofilexml
| [@bs.as "application/vnd.etsi.iptvsad-bc+xml"] `application_vndetsiiptvsadbcxml
| [@bs.as "application/vnd.etsi.iptvsad-cod+xml"] `application_vndetsiiptvsadcodxml
| [@bs.as "application/vnd.etsi.iptvsad-npvr+xml"] `application_vndetsiiptvsadnpvrxml
| [@bs.as "application/vnd.etsi.iptvservice+xml"] `application_vndetsiiptvservicexml
| [@bs.as "application/vnd.etsi.iptvsync+xml"] `application_vndetsiiptvsyncxml
| [@bs.as "application/vnd.etsi.iptvueprofile+xml"] `application_vndetsiiptvueprofilexml
| [@bs.as "application/vnd.etsi.mcid+xml"] `application_vndetsimcidxml
| [@bs.as "application/vnd.etsi.mheg5"] `application_vndetsimheg5
| [@bs.as "application/vnd.etsi.overload-control-policy-dataset+xml"] `application_vndetsioverloadcontrolpolicydatasetxml
...
| [@bs.as "application/vnd.etsi.simservs+xml"] `application_vndetsisimservsxml
| [@bs.as "application/vnd.etsi.timestamp-token"] `application_vndetsitimestamptoken
| [@bs.as "application/vnd.etsi.tsl+xml"] `application_vndetsitslxml
| [@bs.as "application/vnd.etsi.tsl.der"] `application_vndetsitslder
| [@bs.as "application/vnd.evolv.ecig.profile"] `application_vndevolvecigprofile
| [@bs.as "application/vnd.evolv.ecig.settings"] `application_vndevolvecigsettings
...
| [@bs.as "application/vnd.fastcopy-disk-image"] `application_vndfastcopydiskimage
...
| [@bs.as "application/vnd.firemonkeys.cloudcell"] `application_vndfiremonkeyscloudcell
...
| [@bs.as "application/vnd.font-fontforge-sfd"] `application_vndfontfontforgesfd
...
| [@bs.as "application/vnd.fujixerox.docuworks"] `application_vndfujixeroxdocuworks
| [@bs.as "application/vnd.fujixerox.docuworks.binder"] `application_vndfujixeroxdocuworksbinder
| [@bs.as "application/vnd.fujixerox.docuworks.container"] `application_vndfujixeroxdocuworkscontainer
...
| [@bs.as "application/vnd.geometry-explorer"] `application_vndgeometryexplorer
...
| [@bs.as "application/vnd.globalplatform.card-content-mgt"] `application_vndglobalplatformcardcontentmgt
| [@bs.as "application/vnd.globalplatform.card-content-mgt-response"] `application_vndglobalplatformcardcontentmgtresponse
| [@bs.as "application/vnd.gmx"] `application_vndgmx
| [@bs.as "application/vnd.google-earth.kml+xml"] `application_vndgoogleearthkmlxml
...
| [@bs.as "application/vnd.gov.sk.xmldatacontainer+xml"] `application_vndgovskxmldatacontainerxml
...
| [@bs.as "application/vnd.groove-identity-message"] `application_vndgrooveidentitymessage
| [@bs.as "application/vnd.groove-injector"] `application_vndgrooveinjector
| [@bs.as "application/vnd.groove-tool-message"] `application_vndgroovetoolmessage
| [@bs.as "application/vnd.groove-tool-template"] `application_vndgroovetooltemplate
...
| [@bs.as "application/vnd.HandHeld-Entertainment+xml"] `application_vndHandHeldEntertainmentxml
...
| [@bs.as "application/vnd.hhe.lesson-player"] `application_vndhhelessonplayer
...
| [@bs.as "application/vnd.hydrostatix.sof-data"] `application_vndhydrostatixsofdata
...
| [@bs.as "application/vnd.ibm.electronic-media"] `application_vndibmelectronicmedia
| [@bs.as "application/vnd.ibm.MiniPay"] `application_vndibmMiniPay
| [@bs.as "application/vnd.ibm.modcap"] `application_vndibmmodcap
| [@bs.as "application/vnd.ibm.rights-management"] `application_vndibmrightsmanagement
| [@bs.as "application/vnd.ibm.secure-container"] `application_vndibmsecurecontainer
...
| [@bs.as "application/vnd.imagemeter.folder+zip"] `application_vndimagemeterfolderzip
| [@bs.as "application/vnd.imagemeter.image+zip"] `application_vndimagemeterimagezip
...
| [@bs.as "application/vnd.ims.lis.v2.result+json"] `application_vndimslisv2resultjson
| [@bs.as "application/vnd.ims.lti.v2.toolconsumerprofile+json"] `application_vndimsltiv2toolconsumerprofilejson
| [@bs.as "application/vnd.ims.lti.v2.toolproxy.id+json"] `application_vndimsltiv2toolproxyidjson
| [@bs.as "application/vnd.ims.lti.v2.toolproxy+json"] `application_vndimsltiv2toolproxyjson
| [@bs.as "application/vnd.ims.lti.v2.toolsettings+json"] `application_vndimsltiv2toolsettingsjson
| [@bs.as "application/vnd.ims.lti.v2.toolsettings.simple+json"] `application_vndimsltiv2toolsettingssimplejson
| [@bs.as "application/vnd.informedcontrol.rms+xml"] `application_vndinformedcontrolrmsxml
| [@bs.as "application/vnd.infotech.project"] `application_vndinfotechproject
| [@bs.as "application/vnd.infotech.project+xml"] `application_vndinfotechprojectxml
| [@bs.as "application/vnd.informix-visionary"] `application_vndinformixvisionary
| [@bs.as "application/vnd.innopath.wamp.notification"] `application_vndinnopathwampnotification
...
| [@bs.as "application/vnd.intertrust.digibox"] `application_vndintertrustdigibox
...
| [@bs.as "application/vnd.iptc.g2.catalogitem+xml"] `application_vndiptcg2catalogitemxml
| [@bs.as "application/vnd.iptc.g2.conceptitem+xml"] `application_vndiptcg2conceptitemxml
| [@bs.as "application/vnd.iptc.g2.knowledgeitem+xml"] `application_vndiptcg2knowledgeitemxml
| [@bs.as "application/vnd.iptc.g2.newsitem+xml"] `application_vndiptcg2newsitemxml
| [@bs.as "application/vnd.iptc.g2.newsmessage+xml"] `application_vndiptcg2newsmessagexml
| [@bs.as "application/vnd.iptc.g2.packageitem+xml"] `application_vndiptcg2packageitemxml
| [@bs.as "application/vnd.iptc.g2.planningitem+xml"] `application_vndiptcg2planningitemxml
| [@bs.as "application/vnd.ipunplugged.rcprofile"] `application_vndipunpluggedrcprofile
| [@bs.as "application/vnd.irepository.package+xml"] `application_vndirepositorypackagexml
...
| [@bs.as "application/vnd.japannet-directory-service"] `application_vndjapannetdirectoryservice
| [@bs.as "application/vnd.japannet-jpnstore-wakeup"] `application_vndjapannetjpnstorewakeup
| [@bs.as "application/vnd.japannet-payment-wakeup"] `application_vndjapannetpaymentwakeup
| [@bs.as "application/vnd.japannet-registration"] `application_vndjapannetregistration
| [@bs.as "application/vnd.japannet-registration-wakeup"] `application_vndjapannetregistrationwakeup
| [@bs.as "application/vnd.japannet-setstore-wakeup"] `application_vndjapannetsetstorewakeup
| [@bs.as "application/vnd.japannet-verification"] `application_vndjapannetverification
| [@bs.as "application/vnd.japannet-verification-wakeup"] `application_vndjapannetverificationwakeup
| [@bs.as "application/vnd.jcp.javame.midlet-rms"] `application_vndjcpjavamemidletrms
| [@bs.as "application/vnd.jisp"] `application_vndjisp
| [@bs.as "application/vnd.joost.joda-archive"] `application_vndjoostjodaarchive
...
| [@bs.as "application/vnd.liberty-request+xml"] `application_vndlibertyrequestxml
| [@bs.as "application/vnd.llamagraphics.life-balance.desktop"] `application_vndllamagraphicslifebalancedesktop
| [@bs.as "application/vnd.llamagraphics.life-balance.exchange+xml"] `application_vndllamagraphicslifebalanceexchangexml
...
| [@bs.as "application/vnd.macports.portpkg"] `application_vndmacportsportpkg
| [@bs.as "application/vnd.mapbox-vector-tile"] `application_vndmapboxvectortile
| [@bs.as "application/vnd.marlin.drm.actiontoken+xml"] `application_vndmarlindrmactiontokenxml
| [@bs.as "application/vnd.marlin.drm.conftoken+xml"] `application_vndmarlindrmconftokenxml
| [@bs.as "application/vnd.marlin.drm.license+xml"] `application_vndmarlindrmlicensexml
...
| [@bs.as "application/vnd.maxmind.maxmind-db"] `application_vndmaxmindmaxminddb
| [@bs.as "application/vnd.mcd"] `application_vndmcd
| [@bs.as "application/vnd.medcalcdata"] `application_vndmedcalcdata
| [@bs.as "application/vnd.mediastation.cdkey"] `application_vndmediastationcdkey
| [@bs.as "application/vnd.meridian-slingshot"] `application_vndmeridianslingshot
...
| [@bs.as "application/vnd.microsoft.portable-executable"] `application_vndmicrosoftportableexecutable
| [@bs.as "application/vnd.microsoft.windows.thumbnail-cache"] `application_vndmicrosoftwindowsthumbnailcache
| [@bs.as "application/vnd.miele+json"] `application_vndmielejson
| [@bs.as "application/vnd-mif"] `application_vndmif
| [@bs.as "application/vnd.minisoft-hp3000-save"] `application_vndminisofthp3000save
| [@bs.as "application/vnd.mitsubishi.misty-guard.trustweb"] `application_vndmitsubishimistyguardtrustweb
...
| [@bs.as "application/vnd.mophun.application"] `application_vndmophunapplication
| [@bs.as "application/vnd.mophun.certificate"] `application_vndmophuncertificate
| [@bs.as "application/vnd.motorola.flexsuite"] `application_vndmotorolaflexsuite
| [@bs.as "application/vnd.motorola.flexsuite.adsi"] `application_vndmotorolaflexsuiteadsi
| [@bs.as "application/vnd.motorola.flexsuite.fis"] `application_vndmotorolaflexsuitefis
| [@bs.as "application/vnd.motorola.flexsuite.gotap"] `application_vndmotorolaflexsuitegotap
| [@bs.as "application/vnd.motorola.flexsuite.kmr"] `application_vndmotorolaflexsuitekmr
| [@bs.as "application/vnd.motorola.flexsuite.ttc"] `application_vndmotorolaflexsuitettc
| [@bs.as "application/vnd.motorola.flexsuite.wem"] `application_vndmotorolaflexsuitewem
...
| [@bs.as "application/vnd.ms-cab-compressed"] `application_vndmscabcompressed
| [@bs.as "application/vnd.ms-3mfdocument"] `application_vndms3mfdocument
| [@bs.as "application/vnd.ms-excel"] `application_vndmsexcel
| [@bs.as "application/vnd.ms-excel.addin.macroEnabled.12"] `application_vndmsexceladdinmacroEnabled12
| [@bs.as "application/vnd.ms-excel.sheet.binary.macroEnabled.12"] `application_vndmsexcelsheetbinarymacroEnabled12
| [@bs.as "application/vnd.ms-excel.sheet.macroEnabled.12"] `application_vndmsexcelsheetmacroEnabled12
| [@bs.as "application/vnd.ms-excel.template.macroEnabled.12"] `application_vndmsexceltemplatemacroEnabled12
...
| [@bs.as "application/vnd.ms-office.activeX+xml"] `application_vndmsofficeactiveXxml
| [@bs.as "application/vnd.ms-officetheme"] `application_vndmsofficetheme
| [@bs.as "application/vnd.ms-playready.initiator+xml"] `application_vndmsplayreadyinitiatorxml
| [@bs.as "application/vnd.ms-powerpoint"] `application_vndmspowerpoint
| [@bs.as "application/vnd.ms-powerpoint.addin.macroEnabled.12"] `application_vndmspowerpointaddinmacroEnabled12
| [@bs.as "application/vnd.ms-powerpoint.presentation.macroEnabled.12"] `application_vndmspowerpointpresentationmacroEnabled12
| [@bs.as "application/vnd.ms-powerpoint.slide.macroEnabled.12"] `application_vndmspowerpointslidemacroEnabled12
| [@bs.as "application/vnd.ms-powerpoint.slideshow.macroEnabled.12"] `application_vndmspowerpointslideshowmacroEnabled12
| [@bs.as "application/vnd.ms-powerpoint.template.macroEnabled.12"] `application_vndmspowerpointtemplatemacroEnabled12
| [@bs.as "application/vnd.ms-PrintDeviceCapabilities+xml"] `application_vndmsPrintDeviceCapabilitiesxml
| [@bs.as "application/vnd.ms-PrintSchemaTicket+xml"] `application_vndmsPrintSchemaTicketxml
| [@bs.as "application/vnd.ms-project"] `application_vndmsproject
| [@bs.as "application/vnd.ms-tnef"] `application_vndmstnef
| [@bs.as "application/vnd.ms-windows.devicepairing"] `application_vndmswindowsdevicepairing
| [@bs.as "application/vnd.ms-windows.nwprinting.oob"] `application_vndmswindowsnwprintingoob
| [@bs.as "application/vnd.ms-windows.printerpairing"] `application_vndmswindowsprinterpairing
| [@bs.as "application/vnd.ms-windows.wsd.oob"] `application_vndmswindowswsdoob
| [@bs.as "application/vnd.ms-wmdrm.lic-chlg-req"] `application_vndmswmdrmlicchlgreq
| [@bs.as "application/vnd.ms-wmdrm.lic-resp"] `application_vndmswmdrmlicresp
| [@bs.as "application/vnd.ms-wmdrm.meter-chlg-req"] `application_vndmswmdrmmeterchlgreq
| [@bs.as "application/vnd.ms-wmdrm.meter-resp"] `application_vndmswmdrmmeterresp
| [@bs.as "application/vnd.ms-word.document.macroEnabled.12"] `application_vndmsworddocumentmacroEnabled12
| [@bs.as "application/vnd.ms-word.template.macroEnabled.12"] `application_vndmswordtemplatemacroEnabled12
...
| [@bs.as "application/vnd.multiad.creator.cif"] `application_vndmultiadcreatorcif
...
| [@bs.as "application/vnd.neurolanguage.nlu"] `application_vndneurolanguagenlu
| [@bs.as "application/vnd.nintendo.snes.rom"] `application_vndnintendosnesrom
| [@bs.as "application/vnd.nintendo.nitro.rom"] `application_vndnintendonitrorom
| [@bs.as "application/vnd.nitf"] `application_vndnitf
| [@bs.as "application/vnd.noblenet-directory"] `application_vndnoblenetdirectory
...
| [@bs.as "application/vnd.nokia.conml+wbxml"] `application_vndnokiaconmlwbxml
| [@bs.as "application/vnd.nokia.conml+xml"] `application_vndnokiaconmlxml
| [@bs.as "application/vnd.nokia.iptv.config+xml"] `application_vndnokiaiptvconfigxml
| [@bs.as "application/vnd.nokia.iSDS-radio-presets"] `application_vndnokiaiSDSradiopresets
| [@bs.as "application/vnd.nokia.landmark+wbxml"] `application_vndnokialandmarkwbxml
| [@bs.as "application/vnd.nokia.landmark+xml"] `application_vndnokialandmarkxml
| [@bs.as "application/vnd.nokia.landmarkcollection+xml"] `application_vndnokialandmarkcollectionxml
| [@bs.as "application/vnd.nokia.ncd"] `application_vndnokiancd
| [@bs.as "application/vnd.nokia.n-gage.ac+xml"] `application_vndnokiangageacxml
...
| [@bs.as "application/vnd.nokia.radio-preset"] `application_vndnokiaradiopreset
| [@bs.as "application/vnd.nokia.radio-presets"] `application_vndnokiaradiopresets
...
| [@bs.as "application/vnd.ntt-local.content-share"] `application_vndnttlocalcontentshare
| [@bs.as "application/vnd.ntt-local.file-transfer"] `application_vndnttlocalfiletransfer
| [@bs.as "application/vnd.ntt-local.ogw_remote-access"] `application_vndnttlocalogw_remoteaccess
| [@bs.as "application/vnd.ntt-local.sip-ta_remote"] `application_vndnttlocalsipta_remote
| [@bs.as "application/vnd.ntt-local.sip-ta_tcp_stream"] `application_vndnttlocalsipta_tcp_stream
| [@bs.as "application/vnd.oasis.opendocument.chart"] `application_vndoasisopendocumentchart
| [@bs.as "application/vnd.oasis.opendocument.chart-template"] `application_vndoasisopendocumentcharttemplate
| [@bs.as "application/vnd.oasis.opendocument.database"] `application_vndoasisopendocumentdatabase
| [@bs.as "application/vnd.oasis.opendocument.formula"] `application_vndoasisopendocumentformula
| [@bs.as "application/vnd.oasis.opendocument.formula-template"] `application_vndoasisopendocumentformulatemplate
| [@bs.as "application/vnd.oasis.opendocument.graphics"] `application_vndoasisopendocumentgraphics
| [@bs.as "application/vnd.oasis.opendocument.graphics-template"] `application_vndoasisopendocumentgraphicstemplate
| [@bs.as "application/vnd.oasis.opendocument.image"] `application_vndoasisopendocumentimage
| [@bs.as "application/vnd.oasis.opendocument.image-template"] `application_vndoasisopendocumentimagetemplate
| [@bs.as "application/vnd.oasis.opendocument.presentation"] `application_vndoasisopendocumentpresentation
| [@bs.as "application/vnd.oasis.opendocument.presentation-template"] `application_vndoasisopendocumentpresentationtemplate
| [@bs.as "application/vnd.oasis.opendocument.spreadsheet"] `application_vndoasisopendocumentspreadsheet
| [@bs.as "application/vnd.oasis.opendocument.spreadsheet-template"] `application_vndoasisopendocumentspreadsheettemplate
| [@bs.as "application/vnd.oasis.opendocument.text"] `application_vndoasisopendocumenttext
| [@bs.as "application/vnd.oasis.opendocument.text-master"] `application_vndoasisopendocumenttextmaster
| [@bs.as "application/vnd.oasis.opendocument.text-template"] `application_vndoasisopendocumenttexttemplate
| [@bs.as "application/vnd.oasis.opendocument.text-web"] `application_vndoasisopendocumenttextweb
...
| [@bs.as "application/vnd.oipf.contentaccessdownload+xml"] `application_vndoipfcontentaccessdownloadxml
| [@bs.as "application/vnd.oipf.contentaccessstreaming+xml"] `application_vndoipfcontentaccessstreamingxml
| [@bs.as "application/vnd.oipf.cspg-hexbinary"] `application_vndoipfcspghexbinary
| [@bs.as "application/vnd.oipf.dae.svg+xml"] `application_vndoipfdaesvgxml
| [@bs.as "application/vnd.oipf.dae.xhtml+xml"] `application_vndoipfdaexhtmlxml
| [@bs.as "application/vnd.oipf.mippvcontrolmessage+xml"] `application_vndoipfmippvcontrolmessagexml
| [@bs.as "application/vnd.oipf.pae.gem"] `application_vndoipfpaegem
| [@bs.as "application/vnd.oipf.spdiscovery+xml"] `application_vndoipfspdiscoveryxml
| [@bs.as "application/vnd.oipf.spdlist+xml"] `application_vndoipfspdlistxml
| [@bs.as "application/vnd.oipf.ueprofile+xml"] `application_vndoipfueprofilexml
| [@bs.as "application/vnd.oipf.userprofile+xml"] `application_vndoipfuserprofilexml
| [@bs.as "application/vnd.olpc-sugar"] `application_vndolpcsugar
| [@bs.as "application/vnd.oma.bcast.associated-procedure-parameter+xml"] `application_vndomabcastassociatedprocedureparameterxml
| [@bs.as "application/vnd.oma.bcast.drm-trigger+xml"] `application_vndomabcastdrmtriggerxml
...
| [@bs.as "application/vnd.oma.bcast.notification+xml"] `application_vndomabcastnotificationxml
| [@bs.as "application/vnd.oma.bcast.provisioningtrigger"] `application_vndomabcastprovisioningtrigger
| [@bs.as "application/vnd.oma.bcast.sgboot"] `application_vndomabcastsgboot
| [@bs.as "application/vnd.oma.bcast.sgdd+xml"] `application_vndomabcastsgddxml
| [@bs.as "application/vnd.oma.bcast.sgdu"] `application_vndomabcastsgdu
| [@bs.as "application/vnd.oma.bcast.simple-symbol-container"] `application_vndomabcastsimplesymbolcontainer
| [@bs.as "application/vnd.oma.bcast.smartcard-trigger+xml"] `application_vndomabcastsmartcardtriggerxml
| [@bs.as "application/vnd.oma.bcast.sprov+xml"] `application_vndomabcastsprovxml
| [@bs.as "application/vnd.oma.bcast.stkm"] `application_vndomabcaststkm
| [@bs.as "application/vnd.oma.cab-address-book+xml"] `application_vndomacabaddressbookxml
| [@bs.as "application/vnd.oma.cab-feature-handler+xml"] `application_vndomacabfeaturehandlerxml
| [@bs.as "application/vnd.oma.cab-pcc+xml"] `application_vndomacabpccxml
| [@bs.as "application/vnd.oma.cab-subs-invite+xml"] `application_vndomacabsubsinvitexml
| [@bs.as "application/vnd.oma.cab-user-prefs+xml"] `application_vndomacabuserprefsxml
...
| [@bs.as "application/vnd.oma.group-usage-list+xml"] `application_vndomagroupusagelistxml
...
| [@bs.as "application/vnd.oma.poc.detailed-progress-report+xml"] `application_vndomapocdetailedprogressreportxml
| [@bs.as "application/vnd.oma.poc.final-report+xml"] `application_vndomapocfinalreportxml
| [@bs.as "application/vnd.oma.poc.groups+xml"] `application_vndomapocgroupsxml
| [@bs.as "application/vnd.oma.poc.invocation-descriptor+xml"] `application_vndomapocinvocationdescriptorxml
| [@bs.as "application/vnd.oma.poc.optimized-progress-report+xml"] `application_vndomapocoptimizedprogressreportxml
| [@bs.as "application/vnd.oma.push"] `application_vndomapush
| [@bs.as "application/vnd.oma.scidm.messages+xml"] `application_vndomascidmmessagesxml
| [@bs.as "application/vnd.oma.xcap-directory+xml"] `application_vndomaxcapdirectoryxml
...
| [@bs.as "application/vnd.oma-scws-http-request"] `application_vndomascwshttprequest
| [@bs.as "application/vnd.oma-scws-http-response"] `application_vndomascwshttpresponse
...
| [@bs.as "application/vnd.openblox.game-binary"] `application_vndopenbloxgamebinary
| [@bs.as "application/vnd.openblox.game+xml"] `application_vndopenbloxgamexml
| [@bs.as "application/vnd.openeye.oeb"] `application_vndopeneyeoeb
| [@bs.as "application/vnd.openstreetmap.data+xml"] `application_vndopenstreetmapdataxml
| [@bs.as "application/vnd.openxmlformats-officedocument.custom-properties+xml"] `application_vndopenxmlformatsofficedocumentcustompropertiesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.customXmlProperties+xml"] `application_vndopenxmlformatsofficedocumentcustomXmlPropertiesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawing+xml"] `application_vndopenxmlformatsofficedocumentdrawingxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.chart+xml"] `application_vndopenxmlformatsofficedocumentdrawingmlchartxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.chartshapes+xml"] `application_vndopenxmlformatsofficedocumentdrawingmlchartshapesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.diagramColors+xml"] `application_vndopenxmlformatsofficedocumentdrawingmldiagramColorsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.diagramData+xml"] `application_vndopenxmlformatsofficedocumentdrawingmldiagramDataxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.diagramLayout+xml"] `application_vndopenxmlformatsofficedocumentdrawingmldiagramLayoutxml
| [@bs.as "application/vnd.openxmlformats-officedocument.drawingml.diagramStyle+xml"] `application_vndopenxmlformatsofficedocumentdrawingmldiagramStylexml
| [@bs.as "application/vnd.openxmlformats-officedocument.extended-properties+xml"] `application_vndopenxmlformatsofficedocumentextendedpropertiesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.commentAuthors+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlcommentAuthorsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.comments+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlcommentsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.handoutMaster+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlhandoutMasterxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.notesMaster+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlnotesMasterxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.notesSlide+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlnotesSlidexml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.presentation"] `application_vndopenxmlformatsofficedocumentpresentationmlpresentation
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.presentation.main+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlpresentationmainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.presProps+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlpresPropsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slide"] `application_vndopenxmlformatsofficedocumentpresentationmlslide
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slide+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlslidexml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlslideLayoutxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlslideMasterxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slideshow"] `application_vndopenxmlformatsofficedocumentpresentationmlslideshow
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slideshow.main+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlslideshowmainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.slideUpdateInfo+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlslideUpdateInfoxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.tableStyles+xml"] `application_vndopenxmlformatsofficedocumentpresentationmltableStylesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.tags+xml"] `application_vndopenxmlformatsofficedocumentpresentationmltagsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml-template"] `application_vndopenxmlformatsofficedocumentpresentationmltemplate
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.template.main+xml"] `application_vndopenxmlformatsofficedocumentpresentationmltemplatemainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.presentationml.viewProps+xml"] `application_vndopenxmlformatsofficedocumentpresentationmlviewPropsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.calcChain+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlcalcChainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.chartsheet+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlchartsheetxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.comments+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlcommentsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.connections+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlconnectionsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.dialogsheet+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmldialogsheetxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.externalLink+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlexternalLinkxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheDefinition+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlpivotCacheDefinitionxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheRecords+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlpivotCacheRecordsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotTable+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlpivotTablexml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.queryTable+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlqueryTablexml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.revisionHeaders+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlrevisionHeadersxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.revisionLog+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlrevisionLogxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlsharedStringsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"] `application_vndopenxmlformatsofficedocumentspreadsheetmlsheet
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlsheetmainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.sheetMetadata+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlsheetMetadataxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlstylesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.table+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmltablexml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.tableSingleCells+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmltableSingleCellsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml-template"] `application_vndopenxmlformatsofficedocumentspreadsheetmltemplate
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.template.main+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmltemplatemainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.userNames+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmluserNamesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.volatileDependencies+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlvolatileDependenciesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml"] `application_vndopenxmlformatsofficedocumentspreadsheetmlworksheetxml
| [@bs.as "application/vnd.openxmlformats-officedocument.theme+xml"] `application_vndopenxmlformatsofficedocumentthemexml
| [@bs.as "application/vnd.openxmlformats-officedocument.themeOverride+xml"] `application_vndopenxmlformatsofficedocumentthemeOverridexml
| [@bs.as "application/vnd.openxmlformats-officedocument.vmlDrawing"] `application_vndopenxmlformatsofficedocumentvmlDrawing
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlcommentsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.document"] `application_vndopenxmlformatsofficedocumentwordprocessingmldocument
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.document.glossary+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmldocumentglossaryxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmldocumentmainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlendnotesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.fontTable+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlfontTablexml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlfooterxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlfootnotesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlnumberingxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.settings+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlsettingsxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.styles+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlstylesxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml-template"] `application_vndopenxmlformatsofficedocumentwordprocessingmltemplate
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.template.main+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmltemplatemainxml
| [@bs.as "application/vnd.openxmlformats-officedocument.wordprocessingml.webSettings+xml"] `application_vndopenxmlformatsofficedocumentwordprocessingmlwebSettingsxml
| [@bs.as "application/vnd.openxmlformats-package.core-properties+xml"] `application_vndopenxmlformatspackagecorepropertiesxml
| [@bs.as "application/vnd.openxmlformats-package.digital-signature-xmlsignature+xml"] `application_vndopenxmlformatspackagedigitalsignaturexmlsignaturexml
| [@bs.as "application/vnd.openxmlformats-package.relationships+xml"] `application_vndopenxmlformatspackagerelationshipsxml
| [@bs.as "application/vnd.oracle.resource+json"] `application_vndoracleresourcejson
...
| [@bs.as "application/vnd.osgeo.mapguide.package"] `application_vndosgeomapguidepackage
...
| [@bs.as "application/vnd.piaccess.application-licence"] `application_vndpiaccessapplicationlicence
| [@bs.as "application/vnd.picsel"] `application_vndpicsel
| [@bs.as "application/vnd.pmi.widget"] `application_vndpmiwidget
| [@bs.as "application/vnd.poc.group-advertisement+xml"] `application_vndpocgroupadvertisementxml
...
| [@bs.as "application/vnd.previewsystems.box"] `application_vndpreviewsystemsbox
| [@bs.as "application/vnd.proteus.magazine"] `application_vndproteusmagazine
| [@bs.as "application/vnd.psfs"] `application_vndpsfs
| [@bs.as "application/vnd.publishare-delta-tree"] `application_vndpublisharedeltatree
...
| [@bs.as "application/vnd.pwg-xhtml-print+xml"] `application_vndpwgxhtmlprintxml
| [@bs.as "application/vnd.qualcomm.brew-app-res"] `application_vndqualcommbrewappres
| [@bs.as "application/vnd.quarantainenet"] `application_vndquarantainenet
| [@bs.as "application/vnd.Quark.QuarkXPress"] `application_vndQuarkQuarkXPress
| [@bs.as "application/vnd.quobject-quoxdocument"] `application_vndquobjectquoxdocument
| [@bs.as "application/vnd.radisys.moml+xml"] `application_vndradisysmomlxml
| [@bs.as "application/vnd.radisys.msml-audit-conf+xml"] `application_vndradisysmsmlauditconfxml
| [@bs.as "application/vnd.radisys.msml-audit-conn+xml"] `application_vndradisysmsmlauditconnxml
| [@bs.as "application/vnd.radisys.msml-audit-dialog+xml"] `application_vndradisysmsmlauditdialogxml
| [@bs.as "application/vnd.radisys.msml-audit-stream+xml"] `application_vndradisysmsmlauditstreamxml
| [@bs.as "application/vnd.radisys.msml-audit+xml"] `application_vndradisysmsmlauditxml
| [@bs.as "application/vnd.radisys.msml-conf+xml"] `application_vndradisysmsmlconfxml
| [@bs.as "application/vnd.radisys.msml-dialog-base+xml"] `application_vndradisysmsmldialogbasexml
| [@bs.as "application/vnd.radisys.msml-dialog-fax-detect+xml"] `application_vndradisysmsmldialogfaxdetectxml
| [@bs.as "application/vnd.radisys.msml-dialog-fax-sendrecv+xml"] `application_vndradisysmsmldialogfaxsendrecvxml
| [@bs.as "application/vnd.radisys.msml-dialog-group+xml"] `application_vndradisysmsmldialoggroupxml
| [@bs.as "application/vnd.radisys.msml-dialog-speech+xml"] `application_vndradisysmsmldialogspeechxml
| [@bs.as "application/vnd.radisys.msml-dialog-transform+xml"] `application_vndradisysmsmldialogtransformxml
| [@bs.as "application/vnd.radisys.msml-dialog+xml"] `application_vndradisysmsmldialogxml
...
| [@bs.as "application/vnd.recordare.musicxml"] `application_vndrecordaremusicxml
| [@bs.as "application/vnd.recordare.musicxml+xml"] `application_vndrecordaremusicxmlxml
...
| [@bs.as "application/vnd.route66.link66+xml"] `application_vndroute66link66xml
...
| [@bs.as "application/vnd.sailingtracker.track"] `application_vndsailingtrackertrack
...
| [@bs.as "application/vnd.sealedmedia.softseal-html"] `application_vndsealedmediasoftsealhtml
| [@bs.as "application/vnd.sealedmedia.softseal-pdf"] `application_vndsealedmediasoftsealpdf
...
| [@bs.as "application/vnd.shana.informed.formdata"] `application_vndshanainformedformdata
| [@bs.as "application/vnd.shana.informed.formtemplate"] `application_vndshanainformedformtemplate
| [@bs.as "application/vnd.shana.informed.interchange"] `application_vndshanainformedinterchange
| [@bs.as "application/vnd.shana.informed.package"] `application_vndshanainformedpackage
...
| [@bs.as "application/vnd.SimTech-MindMapper"] `application_vndSimTechMindMapper
...
| [@bs.as "application/vnd.software602.filler.form+xml"] `application_vndsoftware602fillerformxml
| [@bs.as "application/vnd.software602.filler.form-xml-zip"] `application_vndsoftware602fillerformxmlzip
...
| [@bs.as "application/vnd.stepmania.package"] `application_vndstepmaniapackage
| [@bs.as "application/vnd.stepmania.stepchart"] `application_vndstepmaniastepchart
...
| [@bs.as "application/vnd.syncml.dm.notification"] `application_vndsyncmldmnotification
| [@bs.as "application/vnd.syncml.dmddf+xml"] `application_vndsyncmldmddfxml
| [@bs.as "application/vnd.syncml.dmtnds+wbxml"] `application_vndsyncmldmtndswbxml
| [@bs.as "application/vnd.syncml.dmtnds+xml"] `application_vndsyncmldmtndsxml
| [@bs.as "application/vnd.syncml.dmddf+wbxml"] `application_vndsyncmldmddfwbxml
...
| [@bs.as "application/vnd.syncml.ds.notification"] `application_vndsyncmldsnotification
...
| [@bs.as "application/vnd.tao.intent-module-archive"] `application_vndtaointentmodulearchive
| [@bs.as "application/vnd.tcpdump.pcap"] `application_vndtcpdumppcap
| [@bs.as "application/vnd.think-cell.ppttc+json"] `application_vndthinkcellppttcjson
| [@bs.as "application/vnd.tml"] `application_vndtml
| [@bs.as "application/vnd.tmd.mediaflex.api+xml"] `application_vndtmdmediaflexapixml
...
| [@bs.as "application/vnd.ubisoft.webplayer"] `application_vndubisoftwebplayer
...
| [@bs.as "application/vnd.uplanet.alert-wbxml"] `application_vnduplanetalertwbxml
| [@bs.as "application/vnd.uplanet.bearer-choice"] `application_vnduplanetbearerchoice
| [@bs.as "application/vnd.uplanet.bearer-choice-wbxml"] `application_vnduplanetbearerchoicewbxml
| [@bs.as "application/vnd.uplanet.cacheop"] `application_vnduplanetcacheop
| [@bs.as "application/vnd.uplanet.cacheop-wbxml"] `application_vnduplanetcacheopwbxml
| [@bs.as "application/vnd.uplanet.channel"] `application_vnduplanetchannel
| [@bs.as "application/vnd.uplanet.channel-wbxml"] `application_vnduplanetchannelwbxml
...
| [@bs.as "application/vnd.uplanet.listcmd-wbxml"] `application_vnduplanetlistcmdwbxml
| [@bs.as "application/vnd.uplanet.list-wbxml"] `application_vnduplanetlistwbxml
| [@bs.as "application/vnd.uri-map"] `application_vndurimap
| [@bs.as "application/vnd.uplanet.signal"] `application_vnduplanetsignal
| [@bs.as "application/vnd.valve.source.material"] `application_vndvalvesourcematerial
...
| [@bs.as "application/vnd.vidsoft.vidconference"] `application_vndvidsoftvidconference
| [@bs.as "application/vnd.visio"] `application_vndvisio
| [@bs.as "application/vnd.visionary"] `application_vndvisionary
| [@bs.as "application/vnd.vividence.scriptfile"] `application_vndvividencescriptfile
...
| [@bs.as "application/vnd.windows.devicepairing"] `application_vndwindowsdevicepairing
| [@bs.as "application/vnd.wmc"] `application_vndwmc
| [@bs.as "application/vnd.wmf.bootstrap"] `application_vndwmfbootstrap
| [@bs.as "application/vnd.wolfram.mathematica"] `application_vndwolframmathematica
| [@bs.as "application/vnd.wolfram.mathematica.package"] `application_vndwolframmathematicapackage
...
| [@bs.as "application/vnd.wrq-hp3000-labelled"] `application_vndwrqhp3000labelled
...
| [@bs.as "application/vnd.yamaha.openscoreformat.osfpvg+xml"] `application_vndyamahaopenscoreformatosfpvgxml
| [@bs.as "application/vnd.yamaha.openscoreformat"] `application_vndyamahaopenscoreformat
| [@bs.as "application/vnd.yamaha.remote-setup"] `application_vndyamaharemotesetup
| [@bs.as "application/vnd.yamaha.smaf-audio"] `application_vndyamahasmafaudio
| [@bs.as "application/vnd.yamaha.smaf-phrase"] `application_vndyamahasmafphrase
| [@bs.as "application/vnd.yamaha.through-ngn"] `application_vndyamahathroughngn
| [@bs.as "application/vnd.yamaha.tunnel-udpencap"] `application_vndyamahatunneludpencap
| [@bs.as "application/vnd.yaoweme"] `application_vndyaoweme
| [@bs.as "application/vnd.yellowriver-custom-menu"] `application_vndyellowrivercustommenu
...
| [@bs.as "application/x-www-form-urlencoded"] `application_xwwwformurlencoded
...
| [@bs.as "application/xcon-conference-info-diff+xml"] `application_xconconferenceinfodiffxml
| [@bs.as "application/xcon-conference-info+xml"] `application_xconconferenceinfoxml
...
| [@bs.as "application/xml-external-parsed-entity"] `application_xmlexternalparsedentity
